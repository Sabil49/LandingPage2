    ...
    <div className="w-full rounded-xl bg-white p-2">
        <div className="w-full bg-[#fafafa] rounded-xl flex">
            ...
            <div className="w-full lg:w-10/12 overflow-hidden">
                ...
                <div className="*:w-[47.25%] gap-y-2 lg:gap-y-0 lg:*:w-1/4 flex flex-wrap lg:flex-nowrap rounded-md *:p-4 gap-x-2 *:rounded-md  *:border border-[rgb(229 229 229)]">
                    <div>
                ...
                <div className="p-4 !pt-0 gap-x-4 gap-y-4 lg:gap-y-0 *:w-full lg:*:w-[32.33%] flex flex-wrap lg:flex-nowrap *:border lg:*:h-[400px] bg-white">
                    <div> 
